...
public partial class Common_ImpactAnalysis : System.Web.UI.Page
{
    string Mbopd = "";
    string Mmscfpd = "";
    ...
    void EnableRequiredDDLs()
    {
        if (Request.QueryString["xWindow_Type"] == "VST")
        {
        ...
        else if (Request.QueryString["xWindow_Type"] == "ST")
        {
        ...
        else if (Request.QueryString["xWindow_Type"] == "MT")
        {
    ...
    protected void submitButton_Click(object sender, EventArgs e)
    {
        ...
        ImpactAnalysis.InsertImpactAnalysis(Request.QueryString["xRequestNumber"].ToString(), txtActivity.Text, txtChangeReason.Text, 
