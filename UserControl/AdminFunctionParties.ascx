<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdminFunctionParties.ascx.cs" Inherits="UserControl_AdminFunctionParties" %>
...
<fieldset>
    <legend>
        <b style="color: green">Functional Supporting Parties</b>
    </legend>
    <table style="color: black">
        ...
        <tr>
            <td>
                <asp:Label ID="lblLocation3" runat="server" Text="Functions:"></asp:Label>
            </td>
            <td>
                <telerik:RadComboBox ID="ddlFunctions" runat="server" AutoPostBack="true" EmptyMessage="Select Function..." RenderMode="Lightweight" Skin="Office2010Silver" Width="300px" OnSelectedIndexChanged="ddlFunctions_SelectedIndexChanged">
                </telerik:RadComboBox>
            </td>
    ...
    <telerik:RadGrid ID="grdView" runat="server" AllowAutomaticDeletes="true" AllowAutomaticInserts="true" AllowAutomaticUpdates="true" AllowPaging="True" AllowSorting="true" Font-Size="11px"
        ...
        <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None" DataKeyNames="IDUSER, FUNCTIONID" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="FUNCTION" HeaderButtonType="TextButton" HeaderText="Function" SortExpression="FUNCTION"></telerik:GridBoundColumn>
