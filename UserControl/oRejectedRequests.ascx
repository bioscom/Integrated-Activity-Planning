<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oRejectedRequests.ascx.cs" Inherits="UserControl_oRejectedRequests" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function ShowCommentFormRejected(id, rowIndex) {
...
<div id="demo" class="demo-container no-bg" style="width: 100%">
    ...
    <telerik:RadGrid RenderMode="Lightweight" ID="grdView" AllowSorting="true" AllowFilteringByColumn="true" runat="server" FilterType="HeaderContext" EnableHeaderContextMenu="true" 
        ...
        <MasterTableView Width="100%" CommandItemDisplay="None" DataKeyNames="IDREQUEST, IDOU" AutoGenerateColumns="false" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
            <Columns>
                ...
                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" ItemStyle-Width="150px" SortExpression="STATUS" HeaderText="Status" HeaderButtonType="TextButton" DataField="STATUS"></telerik:GridBoundColumn>
    ...
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true">
        <Windows>
            ...
            <telerik:RadWindow RenderMode="Lightweight" ID="ReportDialog" runat="server" Title="Report" 
                Height="500px" Width="900px" Left="50px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
        </Windows>
